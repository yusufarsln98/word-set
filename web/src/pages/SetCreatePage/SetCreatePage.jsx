...
import { AutoComplete, Button, Flex, Form, Input, Modal, message } from 'antd'
...
const SetCreatePage = () => {
  ...
  const [flashcards, setFlashcards] = useState([]) // TODO:
  ...
  return (
    <>
      <Metadata title="Create Set" description="Create learnig Sets!" />
      <Form
        name="create-set"
        onFinish={onFinish}
        style={{ width: '100%' }}
